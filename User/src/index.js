...
if (missingVars.length > 0) {
  document.getElementById("root").innerHTML = `
    <div style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:#020c1b;font-family:system-ui;padding:20px;">
      <div style="text-align:center;max-width:480px;">
        ...
        <p style="color:#64748b;margin-top:16px;font-size:13px;">Create a <strong style="color:#94a3b8">.env</strong> file in the User root with these values.</p>
      </div>
    </div>
  `;
